...
Datafeeds.sUDFCompatibleDatafeed = function (datafeedURL, updateFrequency) {
    ...
    this._barsPulseUpdater = new Datafeeds.DataPulseUpdater(this, 0);
...
Datafeeds.UDFCompatibleDatafeed.prototype.resolveSymbol = function (symbolName, onSymbolResolvedCallback, onResolveErrorCallback) {
    ...
    if (!this._configuration.supports_group_request) {
        this._send(this._symbolResolveURL, {
...
Datafeeds.UDFCompatibleDatafeed.initialStep = 500;
Datafeeds.UDFCompatibleDatafeed.prototype._historyURL = "/history";
Datafeeds.UDFCompatibleDatafeed.initialData = null;
Datafeeds.UDFCompatibleDatafeed.onDataCallback = null;

Datafeeds.UDFCompatibleDatafeed.getTickDate = function () {
    var data = {};
    data.t = Datafeeds.UDFCompatibleDatafeed.initialData.t.slice(0, Datafeeds.UDFCompatibleDatafeed.initialStep)
    return data.t[data.t.length - 1]
}

Datafeeds.UDFCompatibleDatafeed.getLastTickPrice = function () {
    if (Datafeeds.UDFCompatibleDatafeed.initialData != null
        && Datafeeds.UDFCompatibleDatafeed.initialData.hasOwnProperty("c")
        && Datafeeds.UDFCompatibleDatafeed.initialData.c.length > 0) {
        var data = {};
        data.c = Datafeeds.UDFCompatibleDatafeed.initialData.c.slice(0, Datafeeds.UDFCompatibleDatafeed.initialStep)
        return data.c[data.c.length - 1]
    } else return 0;
}

Datafeeds.UDFCompatibleDatafeed.forwardChart = function () {
    var data = {};
    Datafeeds.UDFCompatibleDatafeed.initialStep = Datafeeds.UDFCompatibleDatafeed.initialStep + 1
    data.c = Datafeeds.UDFCompatibleDatafeed.initialData.c.slice(0, Datafeeds.UDFCompatibleDatafeed.initialStep)
    data.h = Datafeeds.UDFCompatibleDatafeed.initialData.h.slice(0, Datafeeds.UDFCompatibleDatafeed.initialStep)
    data.l = Datafeeds.UDFCompatibleDatafeed.initialData.l.slice(0, Datafeeds.UDFCompatibleDatafeed.initialStep)
    data.o = Datafeeds.UDFCompatibleDatafeed.initialData.o.slice(0, Datafeeds.UDFCompatibleDatafeed.initialStep)
    data.t = Datafeeds.UDFCompatibleDatafeed.initialData.t.slice(0, Datafeeds.UDFCompatibleDatafeed.initialStep)
    data.s = Datafeeds.UDFCompatibleDatafeed.initialData.s
    //data.v = initialData.v.slice(0, 500)
    ...
    Datafeeds.UDFCompatibleDatafeed.onDataCallback(bars);
}
...
Datafeeds.UDFCompatibleDatafeed.prototype.getBars = function (symbolInfo, resolution, rangeStartDate, rangeEndDate, onDataCallback, onErrorCallback) {
    ...
    this._send(url + this._historyURL, {
        ...
        .done(function (response) {
            Datafeeds.UDFCompatibleDatafeed.initialData = JSON.parse(response);
            var data = {};
            data.c = Datafeeds.UDFCompatibleDatafeed.initialData.c.slice(0, Datafeeds.UDFCompatibleDatafeed.initialStep)
            data.h = Datafeeds.UDFCompatibleDatafeed.initialData.h.slice(0, Datafeeds.UDFCompatibleDatafeed.initialStep)
            data.l = Datafeeds.UDFCompatibleDatafeed.initialData.l.slice(0, Datafeeds.UDFCompatibleDatafeed.initialStep)
            ...
            Datafeeds.UDFCompatibleDatafeed.onDataCallback = onDataCallback;
            onDataCallback(bars);
    ...
    var update = function () {
        ...
        for (var listenerGUID in that._subscribers) {
            ...
            (function (_subscriptionRecord) {
                that._datafeed.getBars(_subscriptionRecord.symbolInfo, resolution, datesRangeLeft, datesRangeRight, function (bars, allBars) {
                        that._requestsPending--;
...
// bar {"index":262,"value":[1426584600,125.9,127.32,125.65,127.04,50839200]}
